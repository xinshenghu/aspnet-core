...
{
    public abstract class MyProjectCoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyProjectCoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyProjectCoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyProjectCoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyProjectCoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyProjectCoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyProjectCoreDbContext, Task<T>> func)
        {
            T result;
