...
using MyProjectCore.Web.Models.Account;
using MyProjectCore.Web.Views.Shared.Components.TenantChange;

namespace MyProjectCore.Web.Controllers
{
    public class AccountController : MyProjectCoreControllerBase
    {
